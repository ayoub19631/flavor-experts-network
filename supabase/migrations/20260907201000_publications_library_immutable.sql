-- Phase 6 apply helper — same publications library as 20260902120000,
-- with immutable to_tsvector(regconfig, text) so Production Postgres accepts generated columns.
-- The original 20260902120000 file is left unchanged and was not applied.
